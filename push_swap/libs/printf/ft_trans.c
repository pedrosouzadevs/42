...
/*   Updated: 2025/01/14 14:33:17 by pedro-hm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_trans_str(char *str, int *count)
{
	if (!str)
	{
		ft_putchar_fd_mod('(', 1, count);
		ft_putchar_fd_mod('n', 1, count);
		ft_putchar_fd_mod('u', 1, count);
		ft_putchar_fd_mod('l', 1, count);
		ft_putchar_fd_mod('l', 1, count);
		ft_putchar_fd_mod(')', 1, count);
	}
	else
		ft_putstr_fd_mod(str, 1, count);
}
...
void	ft_trans_ptr(void *p, char *base, int *count)
{
	...
	{
		n = (unsigned long)p;
		ft_putchar_fd_mod('0', 1, count);
		ft_putchar_fd_mod('x', 1, count);
